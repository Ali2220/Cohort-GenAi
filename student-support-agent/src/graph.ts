...
// ==========================================
// 🛠️ TOOLS CONFIGURATION (MARKETING DEPARTMENT)
// ==========================================

// 1. Apne marketing tools ki list banayi (Abhi isme sirf 1 function hai: getOffers)
...
const graph = new StateGraph(StateAnnotation)
    ...
    // Step 5: Learning support khatam hone par direct end
...
async function main() {
    ...
    const stream = await app.stream({
        messages: [
            {
                role: 'human',
                content: 'Can i get any discount code.'
            }
        ]
    });
