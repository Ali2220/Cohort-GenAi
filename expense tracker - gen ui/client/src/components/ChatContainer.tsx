            ...
            <div className="flex flex-col items-center justify-center h-full min-h-[60vh] px-6 py-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 w-full max-w-2xl px-4">
                {[
                  ...
                  { icon: "📊", title: "Analyze data", desc: "Extract insights from information" },
                  { icon: "✍️", title: "Write content", desc: "Create engaging text and copy" },
                  { icon: "🔧", title: "Solve problems", desc: "Find answers to your questions" },
                ].map((item, idx) => (
